...
#define x_driver_type TMC2208  //For the X driver. See below for your driver type and replace change_value with it.
#define y_driver_type TMC2208  //For the Y driver. See below for your driver type and replace change_value with it.
#define z_driver_type TMC2208  //For the Z driver. See below for your driver type and replace change_value with it.
#define e_driver_type TMC2208  //For the E driver. See below for your driver type and replace change_value with it.
#endif
...
#define MULTIPLE_PROBING 3 //change value to 3 if you need better accuracy in probing. Otherwise, leave as 2
...
#define MIN_PROBE_EDGE 15 //Change this value to 20 if you have clips holding down your print surface. 10 is a good value if you don't have clips. This is how far you want your BLtouch to probe from the EDGES of the bed
...
/*if have a Custom ABL mount and need to put your own values, please use change_value to define your values below. If not, skip this section and continue below*/
  ...
  #define NOZZLE_TO_PROBE_OFFSET { -46, -8, 0 } //Measure the distance between the centre of your probe to the nozzle and replace 'change_value'. KEEP the value 0 there so you can do your z probe offset calibration. Only replace 0 if you know your values. Otherwise your nozzle may CRASH.
#endif
